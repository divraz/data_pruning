...
def load_and_filter_dataset (dataset_name):                                     
  ...
  #dataset = dataset.rename_column ("label", "label_1")                          
                                                                                
  dataset['train'] = dataset['train'].add_column ('indexes', [i + 1 for i in range( len (dataset['train'] ))])
  dataset['test'] = dataset['test'].add_column ('indexes', [i + 1 for i in range( len (dataset['test'] ))])
  dataset['validation'] = dataset['validation'].add_column ('indexes', [i + 1 for i in range( len (dataset['validation'] ))])
